...
(1,  'act001', 'Leonardo DiCaprio',    '1974-11-11', 'American'),
(2,  'act002', 'Tom Hardy',            '1977-09-15', 'British'),
(3,  'act003', 'Joseph Gordon-Levitt', '1981-02-17', 'American'),
(4,  'act004', 'Elliot Page',          '1987-02-21', 'Canadian'),
(5,  'act005', 'Matt Damon',           '1970-10-08', 'American'),
(6,  'act006', 'Christian Bale',       '1974-01-30', 'British'),
(7,  'act007', 'Heath Ledger',         '1979-04-04', 'Australian'),
(8,  'act008', 'Margot Robbie',        '1990-07-02', 'Australian'),
(9,  'act009', 'Brad Pitt',            '1963-12-18', 'American'),
(10, 'act010', 'Cillian Murphy',       '1976-05-25', 'Irish');

-- =====================
-- DIRECTORS
-- =====================
INSERT INTO Director (NodeID, DirectorID, Name, DateOfBirth, Nationality, Awards) VALUES
(11, 'dir001', 'Christopher Nolan',  '1970-07-30', 'British-American', 'Academy Award for Best Director'),
(12, 'dir002', 'Martin Scorsese',    '1942-11-17', 'American',         'Academy Award for Best Director'),
(13, 'dir003', 'Quentin Tarantino',  '1963-03-27', 'American',         'Academy Award for Best Original Screenplay'),
(14, 'dir004', 'Denis Villeneuve',   '1967-10-03', 'Canadian',         'Canadian Screen Award'),
(15, 'dir005', 'Greta Gerwig',       '1983-08-04', 'American',         'Golden Globe Nomination for Best Director');

-- =====================
-- MOVIES
-- =====================
INSERT INTO Movie (NodeID, MovieID, Title, Rating, ReleaseDate, Genre, Runtime) VALUES
(16, 'mov001', 'Inception',              '8.8', '2010-07-16', 'Sci-Fi',    148),
(17, 'mov002', 'The Dark Knight',        '9.0', '2008-07-18', 'Action',    152),
(18, 'mov003', 'Interstellar',           '8.7', '2014-11-07', 'Sci-Fi',    169),
(19, 'mov004', 'The Departed',           '8.5', '2006-10-06', 'Crime',     151),
(20, 'mov005', 'The Wolf of Wall Street','8.2', '2013-12-25', 'Comedy',    180),
(21, 'mov006', 'The Revenant',           '8.0', '2015-12-25', 'Adventure', 156),
(22, 'mov007', 'Inglourious Basterds',   '8.3', '2009-08-21', 'War',       153),
(23, 'mov008', 'Once Upon a Time in Hollywood', '7.6', '2019-07-26', 'Comedy', 161),
(24, 'mov009', 'Django Unchained',       '8.4', '2012-12-25', 'Western',   165),
(25, 'mov010', 'Dunkirk',               '7.8', '2017-07-21', 'War',       106),
(26, 'mov011', 'Oppenheimer',           '8.5', '2023-07-21', 'Drama',     180),
(27, 'mov012', 'The Dark Knight Rises',  '8.4', '2012-07-20', 'Action',    164),
(28, 'mov013', 'Barbie',                '6.8', '2023-07-21', 'Comedy',    114),
(29, 'mov014', 'Shutter Island',        '8.2', '2010-02-19', 'Thriller',  138),
(30, 'mov015', 'Dune',                  '8.0', '2021-10-22', 'Sci-Fi',    155);

-- =====================
-- EDGES: ACTED_IN
-- =====================

-- Inception (mov001): DiCaprio, Hardy, Gordon-Levitt, Elliot Page, Cillian Murphy
